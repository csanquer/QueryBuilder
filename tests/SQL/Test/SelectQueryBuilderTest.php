...
class SelectQueryBuilderTest extends PDOTestCase
{
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->from($table, $alias));
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->innerJoin('book', 'b', 'a.id = b.author_id'));
        $expected = array(
            array(
                'table' => 'book',
                'criteria' => array(
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->leftJoin('book', 'b', 'a.id = b.author_id'));
        $expected = array(
            array(
                'table' => 'book',
                'criteria' => array(
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->rightJoin('book', 'b', 'a.id = b.author_id'));
        $expected = array(
            array(
                'table' => 'book',
                'criteria' => array(
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->groupBy($column, $order));
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->orderBy($column, $order));
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->distinct());
        $this->assertEquals(array('DISTINCT'), $this->queryBuilder->getOptions());
    }

    public function testCalcFoundRows()
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->calcFoundRows());
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->select($column, $alias));
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->having($column, $value, $operator, $connector));
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->having('id', 5, SelectQueryBuilder::BETWEEN));
    }

    public function testAndHaving()
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->andHaving('id', 1, SelectQueryBuilder::EQUALS));
        $expected = array(
            array(
                'column' => 'id',
                'value' => 1,
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->orHaving('id', 1, SelectQueryBuilder::EQUALS));
        $expected = array(
            array(
                'column' => 'id',
                'value' => 1,
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->openHaving($connector));
        $this->assertEquals($expected, $this->queryBuilder->getHavingParts());
    }
    ...
    {
        $this->assertInstanceOf('SelectQueryBuilder', $this->queryBuilder->closeHaving());
        $expected = array(
            Array(
