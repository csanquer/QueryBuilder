...
EOD;
    ...
    {
        $this->assertInstanceOf('SQL\SelectQueryBuilder', $this->queryBuilder->addOption($option));
    ...
    {
        $this->assertInstanceOf('SQL\SelectQueryBuilder', $this->queryBuilder->where($column, $value, $operator, $connector));
    ...
    {
        $this->assertInstanceOf('SQL\SelectQueryBuilder', $this->queryBuilder->where('id', 5, SelectQueryBuilder::BETWEEN));
    }
    ...
    {
        $this->assertInstanceOf('SQL\SelectQueryBuilder', $this->queryBuilder->openWhere($connector));
        $this->assertEquals($expected, $this->queryBuilder->getWhereParts());
    }
    ...
    {
        $this->assertInstanceOf('SQL\SelectQueryBuilder', $this->queryBuilder->closeWhere());
        $expected = array(
            Array(
...
//        var_dump($expectedFormatted, $this->queryBuilder->getWhereString(true));
    ...
    public function getWhereStringProvider()
    {
        ...
        $subquery1
                ->select('id')
                ->from('author')
                ->where('last_name', '%Her%', SelectQueryBuilder::LIKE);

        $subquery2 = new SelectQueryBuilder();
        $subquery2
                ->from('author')
                ->where('first_name', '%Ph%', SelectQueryBuilder::LIKE);
        ...
        return array(
            ...
            array(
                array(
                    array('title LIKE ?', '%the%', SelectQueryBuilder::RAW_CRITERIA, null),
                ),
                'WHERE title LIKE ? ',
                'WHERE title LIKE ? '."\n",
                array(
            ...
            array(
                array(
                    array('score BETWEEN ? AND ?  ', array(5, 8), SelectQueryBuilder::RAW_CRITERIA, null),
                ),
                'WHERE score BETWEEN ? AND ? ',
                'WHERE score BETWEEN ? AND ? '."\n",
                array(5, 8),
            ...
            array(
                array(
                    array('title', '%Dune%', SelectQueryBuilder::NOT_LIKE, null),
                    array('author_id', $subquery1, SelectQueryBuilder::SUB_QUERY_IN, null),
                ),
            ...
            array(
                array(
                    array('title', '%Dune%', SelectQueryBuilder::NOT_LIKE, null),
                    array('author_id', $subquery1, SelectQueryBuilder::SUB_QUERY_NOT_IN, null),
                ),
            ...
            array(
                array(
                    array('title', '%Dune%', SelectQueryBuilder::NOT_LIKE, null),
                    array('author_id', 'SELECT id FROM author WHERE last_name LIKE \'%Her%\'', SelectQueryBuilder::SUB_QUERY_NOT_IN, null),
                ),
            ...
            array(
                array(
                    array('title', '%Dune%', SelectQueryBuilder::NOT_LIKE, null),
                    array('author_id', $subquery2, SelectQueryBuilder::SUB_QUERY_EXISTS, null),
                ),
            ...
            array(
                array(
                    array('title', '%Dune%', SelectQueryBuilder::NOT_LIKE, null),
                    array('', $subquery2, SelectQueryBuilder::SUB_QUERY_NOT_EXISTS, null),
                ),
    ...
    {
        $this->assertEquals($expected, SelectQueryBuilder::debugQuery($query, $params, false));
        $this->assertEquals($expectedQuoted, SelectQueryBuilder::debugQuery($query, $params, true));
        $this->assertEquals($expectedQuotedPDO, SelectQueryBuilder::debugQuery($query, $params, true, self::$pdo));
    }
    ...
    {
        $querybuiler = new SelectQueryBuilder();
     ...
     * @depends testQuery
     */
    public function testQueryGetRowCount(SelectQueryBuilder $queryBuilder)
    {
